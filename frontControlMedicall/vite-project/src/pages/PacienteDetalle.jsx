      ...
      <Form className="mt-5" onSubmit={handleSubmit}>
        ...
        <Row className="mb-3">
          <Form.Group as={Col} controlId="departamento">
            ...
            <Form.Control disabled placeholder={(paciente.ubicacion !== undefined && paciente.ubicacion !== null) ? paciente.ubicacion.departamento : "undefined"} />
          </Form.Group>

          <Form.Group as={Col} controlId="ciudad">
            <Form.Label>Ciudad</Form.Label>
            <Form.Control disabled placeholder={(paciente.ubicacion !== undefined && paciente.ubicacion !== null) ? paciente.ubicacion.ciudad : "undefined"} />
          </Form.Group>

          <Form.Group as={Col} controlId="direccion">
            <Form.Label>Direccion</Form.Label>
            <Form.Control disabled placeholder={(paciente.ubicacion !== undefined && paciente.ubicacion !== null) ? paciente.ubicacion.direccion : "undefined"} />
          </Form.Group>
        ...
        <Row className="justify-content-md-center">
          ...
          <Col ><Button variant="warning" onClick={() => setDisable(!disabled)}>Editar</Button></Col>
          <Col ><Button variant="primary"  onClick={retornarPage}>Volver</Button></Col>
        </Row>
